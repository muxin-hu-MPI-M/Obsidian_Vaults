...
- **Why could this matter for climate?**
	- Although Stokes drift is strongest near the surface, its depth-integrated transport can be spatially organised and not trivially small.
	- Reanalysis products show coherent Stokes transport patterns, including equatorward components in the subtropics, away from major storm-track regions.
	- As Stokes drift also transport heat, this wave-induced pathway may partly oppose the usual poleward redistribution of heat by large-scale circulations. 
