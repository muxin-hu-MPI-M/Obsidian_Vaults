...
- **Diagnostics from reanalysis data (~2 mins)**
	- ~={green}To make this question more concrete, I first used ERA5 wave reanalysis to estimate the scale and spatial structure of Stokes drift and its depth-integrated transport=~
	- ==Figure 2a== shows the climatological depth-integrated Stokes volume transport and its zonal integration. 
