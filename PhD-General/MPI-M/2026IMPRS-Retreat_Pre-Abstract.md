...
However, as you may already noticed the quotation marks around heat transport in the title, these estimates are only one part of the story. They do not include the compensating volume transport or the temperatures carried by that flow, so they cannot determine the net heat transport alone.

Another very important part of the Story that balance the mass is the ocean adjustments. When Stokes drift is introduced, it will trigger the ocean Eulerian adjustments, including the Eulerian compensating flow, pressure-gradient changes, and altered vertical motion. These adjustments can reshape the imposed Stokes drift/transport. This is because the ultimate velocity that transport mass and tracers is now the combination of Stokes drift with the Eulerian compensating flow. Under the wave-averaged theory, this ultimate transport velocity is the Wave-averaged Lagrangian velocity. 
