...
---
# Oral script
When we look at the ocean surface from a beach or a boat, the most visible motion is often the surface waves. These waves are generated by winds blowing over the ocean surface, which transfer energy from the atmosphere into the wave field. Previously, scientists developed the wave model to model the key features
