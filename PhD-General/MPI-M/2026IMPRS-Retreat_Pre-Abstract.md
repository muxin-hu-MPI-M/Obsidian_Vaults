...
---
# Oral script
When we look at the ocean surface from a beach or a boat, the most visible motions, no matter nears you or in the horizon, are often the surface waves. These waves are generated by winds blowing over the ocean surface, which transfer energy from the atmosphere into the wave field. Previously, scientists developed the wave model to describe some key features of wave. Combining with different kinds of observations, allows us to zoom out from one beach or one boat to the global ocean. Here, I show an animation of significant wave height back during later 2025 using the ERA5 wave reanalysis data.
...
- The largest wave heights are often associated with strong wind events, such as tropical cyclones and mid-latitude storms.
