...
The figure shows the OHT control mean and its anomaly. Here, the anomaly is the experiment minus the control. Note that the control mean and anomaly use different vertical scales. The largest changes occur in the mid-latitudes of both hemispheres, reaching approximately 0.08 petawatts, or 80 terawatts. Across the equator, our Stokes-forced experiment shows a southward heat-transport anomaly of about 34 terawatts, equivalent to roughly 12% of the magnitude of the control mean. 
