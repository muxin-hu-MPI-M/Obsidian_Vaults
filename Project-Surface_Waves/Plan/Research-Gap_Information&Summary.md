...
To address the limitations identified above, we aim to investigate wave effects on air–sea interactions in upwelling system using a fully coupled ocean–wave–atmosphere modelling framework. Specifically, we aim to employ the ICON model, in which ICON-a (atmosphere), ICON-Wave (Wave), and ICON-o (Ocean) are coupled using a new energetically consistent exchange of momentum and energy. This framework allows surface waves, atmospheric forcing, and oceanic responses to evolve interactively, while enabling a more realistic representation of key wave-induced processes, including the Langmuir turbulence. The Southeast Pacific (Peru–Chile) upwelling system is chosen as the focus of this study. This region is featured by persistent alongshore winds and a complex wave climate that arises from the coexistence of locally forced wind waves and remotely generated swells, primarily originating from the Souther Ocean. Observations and hindcast studies indicate increasing trends in high-frequency significant wave height extremes in the South Pacific, while future projections suggest a 5–10% increase in mean wave height by the end of the 21st century (Casas-Prat et al., 2024). These features make the Southeast Pacific a sensitive and climatically relevant testbed for the fundamental study on how surface waves modulate air–sea fluxes and influence coastal upwelling dynamics.

Specifically, this PhD seeks to address the following research questions:
1. Which wave-induced processes, including wave-modified momentum fluxes, Stokes-drift-related effects (i.e., Langmuir turbulence, the Coriolis–Stokes force, and Stokes drift on mass and tracer advection), and surface roughness changes, dominate the modulation of air-sea exchanges in upwelling region?
2. How do wave-induced modifications influence the intensity, vertical structure, and temporal variability of upwelling?
...
By systematically incorporating and evaluating multiple wave-induced processes within a fully and energetically consistent coupled modelling framework, this research aims to provide a process-based and quantitative assessment of surface-wave impacts on air-sea interactions in upwelling systems. The results will offer new insight into the mechanisms linking wave climate and coastal upwelling. 
